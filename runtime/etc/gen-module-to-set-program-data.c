...
const char* module_name = "ChapelGenProgramDataSetterModule";
const char* setter_name = "setProgramInfoDataFieldsHere";
const char* formal_name = "info";
const char* formal_type = "chpl_programInfo";
...
static void print_setter_proc(void) {
  printf("  proc %s(ref %s: %s) {\n", setter_name, formal_name, formal_type);
  #define STR(x__) #x__
