...
// TODO (dlongnecke): Does the compiled Chapel program need to provide this
//                    too so we can see that both it and the runtime match?
...
{
  CHPL_PROGRAM_DATA_TEMP(CHPL_PROGRAM_ROOT, CHPL_CACHE_REMOTE);
