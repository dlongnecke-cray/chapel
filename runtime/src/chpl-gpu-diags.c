...
void broadcast_print_unstable(void) {
  chpl_rt_comm_broadcast_rt_constant(chpl_gpu_diags_print_unstable);
}
...
void chpl_gpu_startVerbose(chpl_bool stacktrace,
  ...
  chpl_verbose_gpu = 1;
  chpl_rt_comm_broadcast_rt_constant(chpl_verbose_gpu);
  chpl_rt_comm_broadcast_rt_constant(chpl_verbose_gpu_stacktrace);
}
...
void chpl_gpu_startDiagnostics(chpl_bool print_unstable,
  ...
  chpl_rt_comm_broadcast_rt_constant(chpl_gpu_diagnostics);
}
